...
describe('PoliticalPartyComponent', () => {
    ...
    it('should reset the form after creating a political party', () => {
        ...
        expect(partyForm.value).toEqual({ name: '', founder: '' });
    });
    ...
    it('should delete a political party and update the parties list', () => {
        ...
        expect(mockPartyService.deletePoliticalParty).toHaveBeenCalledWith(partyToDelete.id);
    ...
    it('should be invalid when any field is not filled correctly', () => {
        ...
        nameControl?.setValue('Invalid Name'); // Name is too short
        founderControl?.setValue('Valid Founder Name');
    ...
    it('should display name field error message for invalid name', () => {
        ...
        const errorMessage = fixture.nativeElement.querySelector('.name-error-message');
        expect(errorMessage.textContent).toContain('Name must be at least 3 characters long.');
    });
